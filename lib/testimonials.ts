...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    id: '18',
    name: 'Julie Savitz',
    role: 'M.S. Reinvention Strategist',
    quote: "Jenni Smith is the kind of entrepreneur who actually cares about the person behind the business. She doesn't rush the process or hand you a generic plan. She listens, asks the right questions, and figures out where you are before helping you move forward. What stands out is how intentional she is. Jenni takes the time to understand your goals, your strengths, and even what's been holding you back, then helps you take clear next steps that feel doable instead of overwhelming. If you want someone who is thoughtful, invested, and genuinely committed to your growth, I highly recommend working with Jenni.",
  },
];
